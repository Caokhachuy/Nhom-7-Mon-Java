...
<body>
	...
	<div class="row" style="margin-left:0px;margin-right:0px;">
		<div class="col-12" style="text-align:center;background-color: green;">
			SMARTH PHONE CKH HỖ TRỢ GIAO HÀNG VÀ THU TIỀN TẬN NƠI TRÊN TOÀN QUỐC
		</div>
	</div>
	
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
	  <a class="navbar-brand" href="/banphukiendt/">Home</a>
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      <c:forEach var="item" items="${ListLoaiMay}">
		      <li class="nav-item">
		        <a class="nav-link" href="/banphukiendt/chitietloaisanpham/${item.idLoaiMay}">${item.tenLoaiMay}</a>
		      </li>
	      </c:forEach>
	      <li class="nav-item dropdown">
	        <a class="nav-link dropdown-toggle" href="/banphukiendt/giohang" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	        ...
	        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
	          ...
	          <c:if test="${sessionScope.count>0}">
		          ...
		          <div class="row">
		          	...
		          	<div class="col-12">
			          	<a href="/banphukiendt/giohang"><span style="font-size:10px; margin-left:0px;">Chi tiết</span></a>
			        </div>
		          </div>
	          </c:if>
	        </div>
